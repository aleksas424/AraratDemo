...
export default {
  ...
  data() {
      ...
      dishes: [
        {
          name: "Basturma",
          price: 6.0,
          image: new URL('@/assets/Sriubos/basturma.png', import.meta.url).href,
          category: "Užkandžiai",
        ...
        },
        {
          name: "Sūrių rinkinys",
          price: 8.0,
          image: new URL('@/assets/Sriubos/suriorinkinys.png', import.meta.url).href,
          category: "Užkandžiai",
        ...
        },
        {
          ...
          price: 7.0,
          image: new URL('@/assets/Sriubos/suriospurgos.png', import.meta.url).href,
          category: "Užkandžiai",
          description: "Vytinta jautiena arba jautienos dešra armėniškų prieskonių mišinyje, pagaminta pagal autentišką šeimos receptą",
        },
        {
          ...
          price: 4.0,
          image: new URL('@/assets/Sriubos/lavasotraskuciai.png', import.meta.url).href,
          category: "Užkandžiai",
        ...
        },
        {
          ...
          price: 5.0,
          image: new URL('@/assets/Sriubos/keptaduona.png', import.meta.url).href,
          category: "Užkandžiai",
          description: "Kepta duona su česnaku",
        },
        {
          name: "Lavašas",
          price: 2.5,
          image: new URL('@/assets/Sriubos/lavasas.png', import.meta.url).href,
          category: "Užkandžiai",
    ...
    price: 8.0,
    image: new URL('@/assets/Sriubos/Charciosuaviena.png', import.meta.url).href,
    category: "Sriubos",
    description: "Aštri kaukazietiška avienos sriuba",
        },
        {
          ...
          price: 6.0,
          image: new URL('@/assets/Sriubos/charciosujautiena.png', import.meta.url).href,
          category: "Sriubos",
        ...
        },
        {
          ...
          price: 8.0,
          image: new URL('@/assets/Sriubos/chaclamasujautiena.png', import.meta.url).href,          
          category: "Sriubos",
        ...
        },
        {
          ...
          price: 11.0,
          image: new URL('@/assets/Sriubos/avienosliulekabab.png', import.meta.url).href,
          category: "Aviena",
          ...
          price: 11.0,
          image: new URL('@/assets/Sriubos/chaciapuri.png', import.meta.url).href,
          category: "Chačapuri",
          ...
          price: 10.0,
          image: new URL('@/assets/Sriubos/adzarijoschaciapuri.png', import.meta.url).href,
          category: "Chačapuri",
          description: "Adžarijos chačapuri su kiaušiniu",
        },{
          name: "ARARAT chačapuri ant iešmo",
          price: 9.0,
          image: new URL('@/assets/Sriubos/araratchaciapuriantiesmo.png', import.meta.url).href,
          category: "Chačapuri",
